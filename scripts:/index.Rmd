...
## Chart 2: Point Differentials When Favorites Win vs. Lose
...
scores_df %>% 
  ...
  xlab("") + ylab("Game Point Differential") + xlab("Favorite Won")
```

This chart aims to show how closer games are when favorites lose. We can see that the point differential is lower than when favorites win.
